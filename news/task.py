...
def add_post_send_email(category, id):
    ...
    for user_email in list_mail:
        ...
        html_content = render_to_string('subscribe.html', {'post': post, 'username': username, 'category': category})
        msg = EmailMultiAlternatives(

            subject=f'News: {category}',
            body='',
            from_email='news272@gmail.com',
            to=[user_email, ],
             )
